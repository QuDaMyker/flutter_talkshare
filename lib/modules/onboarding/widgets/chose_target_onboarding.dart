...
class ChoseTargetBoarding extends StatelessWidget {
  const ChoseTargetBoarding({
    super.key,
    required this.title,
            ...
            return Column(
              children: [
                ItemCheckBox(
                  onSelected: (p0) {
                    setState(() {
                      onBoardingController.onSelectedTarget(p0);
                    });
                  },
                  groupValue: onBoardingController.selectedTarget.value,
                  id: element['id'],
                  icon: element['icon'],
                  title: element['title'],
                ),
