...
class CustomDialog extends StatelessWidget {
  const CustomDialog({
    super.key,
    required this.countStudying,
    required this.countStudied,
  });
  final String countStudying;
  final String countStudied;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Bạn đã học được $countStudied từ',
            ...
            Text(
              'Chỉ còn $countStudying từ nữa thôi, cố lên nào!!!',
              style: const TextStyle(
                color: Colors.black,
                fontWeight: FontWeight.bold,
              ),
